...
#define X(T) \
    m.def("nmf", &planc::nmflib<T>::nmf, "A function that calls NMF with the given arguments", "x"_a, "k"_a, "niter"_a=30, "algo"_a="anlsbpp", "ncores"_a=2, nb::kw_only(), "Winit"_a = arma::mat(), "Hinit"_a = arma::mat(), nb::call_guard<nb::gil_scoped_release>()); \
    m.def("symNMF", &planc::nmflib<T>::symNMF, "A function that calls symNMF with the given arguments", "x"_a, "k"_a, "niter"_a=30, "lambda"_a=0.0, "algo"_a="gnsym", "ncores"_a=2,  nb::kw_only(), "Hinit"_a = arma::mat(), nb::call_guard<nb::gil_scoped_release>());
    #include "nmf_types.inc"
#undef X
#define X(T) \
    m.def("bppinmf", nb::overload_cast<std::vector<T>, const arma::uword&, const double&, const arma::uword&, const bool&, const int&>(&planc::bppinmf_py<T>), "A function that calls bppinmf with the given arguments", "objectList"_a, "k"_a, "lambda"_a=5.0, "niter"_a=30, "verbose"_a=false, "ncores"_a=2, nb::call_guard<nb::gil_scoped_release>()); \
    m.def("bppinmf", nb::overload_cast<std::vector<T>, const arma::uword&, const double&, const arma::uword&, const bool&, const std::vector<arma::mat>&, const std::vector<arma::mat>&, const arma::mat&, const int&>(&planc::bppinmf_py<T>), "A function that calls bppinmf with the given arguments", "objectList"_a, "k"_a, "lambda"_a=5.0, "niter"_a=30, "verbose"_a=false, "HinitList"_a, "VinitList"_a, "&Winit"_a,"ncores"_a=2, nb::call_guard<nb::gil_scoped_release>()); \
    m.def("uinmf", &planc::uinmf_py<T>, "A function that calls uinmf with the given arguments", "objectList"_a, "unsharedList"_a, "whichUnshared"_a, "k"_a=20, "nCores"_a=2, "lambda"_a=5, "niter"_a=30, "verbose"_a=false, nb::call_guard<nb::gil_scoped_release>()); \
    m.def("oinmf", nb::overload_cast<std::vector<T>, const arma::uword&, const int&, const double&, const arma::uword&, const arma::uword&, const arma::uword&, const arma::uword&, const bool&>(&planc::oinmf_py<T>), "A function that calls oinmf with the given arguments", "objectList"_a, "k"_a, "nCores"_a=2, "lambda"_a=5, "maxEpoch"_a=5, "minibatchSize"_a=5000, "maxHALSIter"_a=1, "permuteChunkSize"_a=1000, "verbose"_a=false, nb::call_guard<nb::gil_scoped_release>()); \
    m.def("oinmf", nb::overload_cast<std::vector<T>, const std::vector<arma::mat>&, const std::vector<arma::mat>&, const arma::mat&, const std::vector<arma::mat>&, const std::vector<arma::mat>&, std::vector<T>, const arma::uword&, const int&, const double&, const arma::uword&, const arma::uword&, const arma::uword&, const arma::uword&, const bool&>(&planc::oinmf_py<T>), "A function that calls oinmf with the given arguments", "objectList"_a, "Hinit"_a, "Vinit"_a, "Winit"_a, "Ainit"_a, "Binit"_a, "objectListNew"_a, "k"_a, "nCores"_a=2, "lambda"_a=5, "maxEpoch"_a=5, "minibatchSize"_a=5000, "maxHALSIter"_a=1, "permuteChunkSize"_a=1000, "verbose"_a=false, nb::call_guard<nb::gil_scoped_release>()); \
    m.def("oinmf_project", &planc::oinmf_project_py<T>, "A function that calls oinmf_project with the given arguments", "objectList"_a, "Winit"_a, "objectListNew"_a, "k"_a, "nCores"_a = 2, "lambda"_a=5, nb::call_guard<nb::gil_scoped_release>());
