...
#define X(T) \
    ...
    m.def("oinmf", nb::overload_cast<const std::vector<T>&, const arma::uword&, const int&, const double&, const arma::uword&, const arma::uword&, const arma::uword&, const bool&>(&planc::nmflib<T>::oinmf), "A function that calls oinmf with the given arguments", "objectList"_a, "k"_a, "nCores"_a=2, "lambda"_a=5, "maxEpoch"_a=5, "minibatchSize"_a=5000, "maxHALSIter"_a=1, "verbose"_a=false); \
    m.def("oinmf", nb::overload_cast<const std::vector<T>&, const std::vector<arma::mat>&, const arma::mat&, const std::vector<arma::mat>&, const std::vector<arma::mat>&, const std::vector<T>&, const arma::uword&, const int&, const double&, const arma::uword&, const arma::uword&, const arma::uword&, const bool&>(&planc::nmflib<T>::oinmf), "A function that calls oinmf with the given arguments", "objectList"_a, "Vinit"_a, "Winit"_a, "Ainit"_a, "Binit"_a, "objectListNew"_a, "k"_a, "nCores"_a=2, "lambda"_a=5, "maxEpoch"_a=5, "minibatchSize"_a=5000, "maxHALSIter"_a=1, "verbose"_a=false); \
