...
#define X(T) \
template planc::nnlslib<T, double>::nnlslib(); \
template arma::mat planc::nnlslib<T, double>::runbppnnls(const arma::mat &C, const T &B, const int &ncores); \
template arma::mat planc::nnlslib<T, double>::runbppnnls(const arma::mat &C, const std::variant<arma::sp_mat, arma::mat> &B, const int &ncores);
