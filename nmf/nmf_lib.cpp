...
#undef X
#define X(T) \
template planc::inmfOutput<double> planc::nmflib<T, double>::bppinmf(std::vector<T> objectlist, arma::uword k, double lambda, arma::uword niter, bool verbose, const int &nCores);
